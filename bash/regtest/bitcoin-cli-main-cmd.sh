...
logshow "command : " ./bitcoin-cli -regtest -rpcport=$BITCOIND_RPCPORT -rpcconnect=$target_rpcaddr -datadir=${datadir_path} $bitcoin_arg
./bitcoin-cli -rpcport=$BITCOIND_RPCPORT -rpcconnect=$target_rpcaddr -datadir=${datadir_path} $bitcoin_arg
