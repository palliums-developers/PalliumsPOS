...
logshow "command : " ./bitcoin-cli -testnet -rpcport=$BITCOIND_TESTRPCPORT -rpcconnect=$target_rpcaddr -datadir=${datadir_path} $bitcoin_arg
./bitcoin-cli -testnet -rpcport=$BITCOIND_TESTRPCPORT -rpcconnect=$target_rpcaddr -datadir=${datadir_path} $bitcoin_arg
