...
/* Omni Core - transaction calls */
    ...
    { "omni_sendregisternodetoken", 1, "ecosystem" },
    { "omni_sendregisternodetoken", 2, "type" },
    { "omni_sendregisternodetoken", 3, "previousid" },
    { "sinnga_sendissuancefixed", 1, "ecosystem" },
    { "sinnga_sendissuancefixed", 2, "type" },
    { "sinnga_sendissuancefixed", 3, "previousid" },
